...
struct Matrix33
{
	...
	Vec3 cols[3];
	 ...
	 static inline Matrix33 Identity() {  const Matrix33 sIdentity(Vec3(1.0f, 0.0f, 0.0f), Vec3(0.0f, 1.0f, 0.0f), Vec3(0.0f, 0.0f, 1.0f)); return sIdentity; }
};
 ...
 inline Matrix33 Outer(const Vec3& a, const Vec3& b)
{
 ...
 inline Matrix33 Inverse(const Matrix33& a, bool& success)
{
 ...
 inline Matrix33& operator-=(Matrix33& a, const Matrix33& b) { a = a-b; return a; }
 inline Matrix33& operator*=(Matrix33& a, float s) { a.cols[0]*=s; a.cols[1]*=s; a.cols[2]*=s;  return a; }

template <typename T>
 inline XQuat<T>::XQuat(const Matrix33& m)
{
